  ...
  return (
    <div className="min-h-screen bg-[#eaeded] py-6 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {items.length === 0 ? (
          /* Empty Cart State */
          <div className="bg-white p-8 sm:p-12 rounded-lg shadow-xs border border-gray-200 flex flex-col md:flex-row items-center gap-8">
            <div className="w-28 h-28 rounded-full bg-gray-50 flex items-center justify-center shrink-0 border border-gray-100">
              <ShoppingCart className="w-14 h-14 text-gray-400" />
            </div>
            <div className="space-y-3 text-center md:text-left">
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Your Apex Cart is empty</h1>
