...
<div align="center">
  <img src="./image/1.png" alt="Pehno Homepage Banner" style="border-radius: 12px; margin-bottom: 20px;" width="100%"/>
</div>
...
<div align="center">
  <img src="./image/2.png" alt="Pehno UI" width="48%" style="margin: 1%; border-radius: 8px;"/>
  <img src="./image/3.png" alt="Pehno UI" width="48%" style="margin: 1%; border-radius: 8px;"/>
  <img src="./image/4.png" alt="Pehno UI" width="48%" style="margin: 1%; border-radius: 8px;"/>
  <img src="./image/5.png" alt="Pehno UI" width="48%" style="margin: 1%; border-radius: 8px;"/>
  <img src="./image/6.png" alt="Pehno UI" width="48%" style="margin: 1%; border-radius: 8px;"/>
  <img src="./image/7.png" alt="Pehno UI" width="48%" style="margin: 1%; border-radius: 8px;"/>
  <img src="./image/8.png" alt="Pehno UI" width="48%" style="margin: 1%; border-radius: 8px;"/>
  <img src="./image/9.png" alt="Pehno UI" width="48%" style="margin: 1%; border-radius: 8px;"/>
</div>

### Shopping, AI & Checkout Flow
<div align="center">
  <img src="./image/10.png" alt="Pehno App Flow" width="31%" style="margin: 1%; border-radius: 8px;"/>
  <img src="./image/11.png" alt="Pehno App Flow" width="31%" style="margin: 1%; border-radius: 8px;"/>
  <img src="./image/12.png" alt="Pehno App Flow" width="31%" style="margin: 1%; border-radius: 8px;"/>
  <img src="./image/13.png" alt="Pehno App Flow" width="31%" style="margin: 1%; border-radius: 8px;"/>
  <img src="./image/14.png" alt="Pehno App Flow" width="31%" style="margin: 1%; border-radius: 8px;"/>
  <img src="./image/15.png" alt="Pehno App Flow" width="31%" style="margin: 1%; border-radius: 8px;"/>
  <img src="./image/16.png" alt="Pehno App Flow" width="31%" style="margin: 1%; border-radius: 8px;"/>
  <img src="./image/17.png" alt="Pehno App Flow" width="31%" style="margin: 1%; border-radius: 8px;"/>
  <img src="./image/18.png" alt="Pehno App Flow" width="31%" style="margin: 1%; border-radius: 8px;"/>
</div>
